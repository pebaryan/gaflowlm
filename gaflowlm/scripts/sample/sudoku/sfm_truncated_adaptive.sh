...
CKPT_PATH="${CKPT_PATH:?set CKPT_PATH to the trained SFM truncated+adaptive sudoku checkpoint}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
DIFFICULTY="${DIFFICULTY:-easy}"      # easy / medium / hard
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/sudoku/sfm_truncated_adaptive_${DIFFICULTY}}"
